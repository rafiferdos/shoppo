  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      ...
      <div className="flex flex-col gap-4 p-6 md:p-10 relative overflow-hidden items-center justify-center">
        <div className="w-full max-w-xl relative z-10 bg-background/60 backdrop-blur-sm p-12 rounded-xl border border-border/40 shadow-sm flex flex-col items-center">
